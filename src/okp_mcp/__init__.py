...
from . import metrics as _metrics  # noqa: F401 — import registers @mcp.custom_route("/metrics")
from . import server as _server
from . import tools as _tools  # noqa: F401 — import triggers @mcp.tool registration
from .build_info import get_commit_sha, get_package_version
from .config import ServerConfig
from .metrics import PrometheusMiddleware
from .request_id import RequestIDLogFilter, build_http_request_id_middleware
